...
import Image from "next/image"; // Re-added the Image import
          ...
          >
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative">
                <div className="relative h-9 w-9 rounded-xl overflow-hidden shadow-lg transition-all duration-300 group-hover:shadow-red-500/25 group-hover:shadow-xl">
                  {/* --- IMAGE ADDED HERE --- */}
                  <Image
                    src="/reda.jpeg"
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-red-500/20 to-rose-500/20 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </div>
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="p-6 border-b border-white/10">
                  ...
                  >
                    ...
                    <div>
                      <div className="font-semibold text-white">Alouache Abdelmoula</div>
                      <div className="text-xs text-gray-400 font-mono">Cybersecurity Engineer</div>
                    </div>
                  </Link>
                </div>
                    ...
                    >
                      <Link
                        ...
                        className={`flex items-center p-4 rounded-xl font-medium transition-all duration-500 group relative overflow-hidden ${
                          isActive(item.href)
                            ? "bg-gradient-to-r from-red-500/15 to-rose-500/10 text-red-400 border border-red-500/30 shadow-lg shadow-red-500/10"
